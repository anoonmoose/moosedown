...
are that you pour junk into your (local!) database or get your api key revoked

note:  since there's no authentication, this can't possibly screw up
last.fm's copy of the data, so there's really no possible harm here
*/
